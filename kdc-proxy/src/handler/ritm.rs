use kile::{KdcFrame, roast::Roastable, AsReqExt, constants::ETYPE_RC4_HMAC_MD5, KrbErrorExt};
        ...
        match &frame {
            KdcFrame::AsReq(as_req) => match as_req.get_pa_etype() {
                ...
                Some(_) => {
                    ...
                    let reply = KrbError::new_preauth_required(realm.to_owned(), ETYPE_RC4_HMAC_MD5);
